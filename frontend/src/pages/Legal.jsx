...
const TERMS = {
  ...
  sections: [
    ...
    { h: "4. Illustrative content", p: "Certain case studies, outcome figures and quotes on this website are illustrative scenarios, clearly labelled as such, presented to demonstrate our method and the outcomes it targets. They should not be relied upon as verified claims." },
