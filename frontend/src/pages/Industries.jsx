    ...
    <div data-testid="industries-page">
      ...
      <section className="pt-40 pb-20 border-b border-line relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <p className="label-tech text-accentText mb-8">Industries</p>
          <LineReveal
            as="h1"
              ...
              {industries.map((ind, i) => (
                <Reveal key={ind.slug} delay={(i % 2) * 0.08}>
                  <Link
                    ...
                    className="group flex flex-col h-full min-h-[260px] p-8 md:p-12 bg-bg hover:bg-surface transition-colors duration-500"
                  >
                    ...
                    <h2 className="mt-14 font-grotesk font-semibold text-2xl md:text-3xl group-hover:text-accentText transition-colors duration-300">
                      {ind.name}
                    </h2>
